        ...
        <div>
          ...
          <div className="cs1 ce12 text-container">
            ...
            <p style={{ fontSize: textSize.referenceParagraphSize, marginTop: "-10px", display: "inline"}} className="description text-alt">
              1. To use the plugin, go to <span onClick={() => window.open('https://console.picsart.io/?source=miro&utm_medium=app&utm_campaign=plugins', '_blank')} style={{ color: "#C209C1", cursor: "pointer", }}>picsart.io</span> and create a free account. <div></div>
            </p>
            <p style={{ fontSize: textSize.referenceParagraphSize, marginTop: "-10px", display: "inline" }} className="description text-alt">
              2. Go to the <span onClick={() => window.open('https://console.picsart.io/?source=miro&utm_medium=app&utm_campaign=plugins', '_blank')} style={{ color: "#C209C1", cursor: "pointer", }}>Console</span>, copy and past your API key here.
            </p>
          </div>
          <input
